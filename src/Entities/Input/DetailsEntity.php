...
use Suzunone\CodeRunner\Entities\Elements\Input\Details;
 ...
 */
class DetailsEntity extends InputEntityBase implements InputEntityInterface
{
    /**
    ...
    {
        $this->element = new Details($attribute);
    }
}
